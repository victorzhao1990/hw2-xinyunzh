...
public class AnnoType_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.victorzhao.hw2.types.AnnoType");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "com.victorzhao.hw2.types.AnnoType");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("Id", "com.victorzhao.hw2.types.AnnoType");
