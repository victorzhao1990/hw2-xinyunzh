 ...
 * @generated */
public class AbAnnoType_Type extends Annotation_Type {
  /** @generated 
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "com.victorzhao.hw2.types.AbAnnoType");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("Id", "com.victorzhao.hw2.types.AbAnnoType");
